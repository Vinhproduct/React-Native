    ...
    <ScrollView style={{ marginTop: 55 }}>
          ...
          >
            ...
            <Text style={{ flex: 1 }}>
              <Text style={{ color: "green", fontWeight: "500" }}>
                Đơn hàng của bạn sẽ được giao sau 2 ngày
              </Text>{" "}
              - Miễn phí giao hàng
            </Text>
          </View>
      ...
      {currentStep === 3 && selectedOption === "cash" && (
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            <Text>
              Vận chuyển đến {selectedAddress?.name}</Text>
            ...
            >
              ...
              <Text style={{ color: "gray", fontSize: 16 }}>{total}:VNĐ</Text>
            </View>
            ...
            >
              ...
              <Text style={{ color: "gray", fontSize: 16 }}>0:VNĐ</Text>
            </View>
